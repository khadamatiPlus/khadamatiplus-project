            ...
            <form action="{{ route('admin.coupon.store') }}" method="POST">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="code" class="form-control" value="{{ old('code') }}" required placeholder="e.g., SUMMER2024">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" name="minimum_order_amount" class="form-control" value="{{ old('minimum_order_amount') }}" step="0.01" min="0" placeholder="0.00">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="number" name="maximum_discount_amount" class="form-control" value="{{ old('maximum_discount_amount') }}" step="0.01" min="0" placeholder="No limit">
